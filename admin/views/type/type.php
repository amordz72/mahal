...
<?php 
 session_start(); include_once 'db.php';
...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
 <link rel="stylesheet" href="css/type_style.css">
...
<div class="container-fluid">
  <nav class="navbar  fixed-top navbar-expand-lg  navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><spane>A</span>mor<spane>T</span>ec</a>
...
<!--START-CONTAINER-BODY-->
  <div class="container-fluid" id='App_type'>
...
<!--START-FORM-->
<form class="row"  method="POST" id="frmtype">
...
<!--START-BUTTON-->
<div id="btn-div">
<input type='button' id="btn_add_type" name="btn_add_type" class='btn btn-success' v-model='actionButton' @click='submitData_type' />
<input type='button' class="btn btn-danger" id="btn_del_type" name="btn_del_type" @click='deleteData_type(TYID)' value="DELETE :"/> 
 <input type='button' id="btn_add_db_type" name="btn_add_db_type" class='btn btn-success'  @click="add_row()"value="To dgv :"/>
 <input type='button' id="btn_add_dgv_type" name="btn_add_dgv_type" class='btn btn-success'   @click='add_all_type()' value="DgvToBb  :"/>
  <input type = "button" class="btn btn-success btn-xs" @click="openModel_type" value="New" />
...
<!--START-COL-MD-8-->
<div class="col-md-8">
  <div class="container" id="App_type">
   <br />
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
     <div class="row">
      <div class="col-md-6">
       <h3 class="panel-title"><i class="fas fa-phone"></i> &spar; TYPE Data</h3>
      </div>
      <div class="col-md-6" align="right">
       <input type="button" class="btn btn-success btn-xs" @click="openModel_type" value="Add" />
      </div>
     </div>
    </div>
<!--START-SERCHE-->
 <div class="container pb-4  ">
 <div class="row"><input class="col-9" type="text" id="txt_serche" @change='typeSerche()'  placeholder="Search for names.." title="Type in a name">
...
<table class="table table-bordered table-striped table-hover fs-12 " id="tbl_type" name="tbl_type">
 <tr>
...
<script src="js/type_js.js"></script>
