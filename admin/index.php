...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $stmt = $con->prepare("select usId,usName,usPw from users where  usName=? and usPw=? and tyNum=1");
...
<div class="container  my-5 " id="App_users">
  <div class="row px-2">
    <form id="frm" action="<?php thisPage() ?>" method="POST" class="col-lg-8  mx-auto pb-3 login">
      <h2 class=" text-center fs-4 "><i class="fa fa-user fa-lg  mt-5 mb-3" aria-hidden="true"><?php _lang('loginTitle' )  ?> </i>    </h2>
